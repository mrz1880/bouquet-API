...
CREATE TABLE "seller" (
  ...
  "shop_presentation" VARCHAR(600) NOT NULL,
  -- pour avoir la date et l'heure on utilise le type "timestamp", et pour être le plus précis possible on utilisera plutôt le type "timestampz" qui contient en plus de la date et de l'heure le fuseau horaire défini dans les locales du serveur
  -- pensez à la réunion Meet avec les collègues internationaux
  "created_at" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  "updated_at" TIMESTAMPTZ
...
VALUES ('M', 'Jean', 'DelaFontaine', 'jean@gmail.com', '$2b$10$NGpt26IWjW44yo7FjAS/zetwjpwgnsWRX4o/9M4MyRhEzrt.Ia7vu', '0712344556', 'Boulevard de Cessole', '23', 'Paris', '75000' ),
       ('M', 'Leonard', 'Devinci', 'davinci@gmail.com', '$2b$10$NCC3Cl2iieokeqVpHz1x9.uqjz1v881JYWwiQhGCcngfQqPzKbrH.', '0761861314', 'Laguet', '11', 'Bordeaux', '33000' ),
       ('F', 'Clara', 'Watson', 'watson@gmail.com', '$2b$10$CbL2ZFXLu/4msdC5qEJU4.1U0a8af4QiGKYWBWlBMkwGaeRJSKQm2', '0661673140', 'Fanny', '2', 'Poitiers', '86000' );
...
VALUES ('M', 'Edmond', 'Dantes', 'dantes@gmail.com', '$2b$10$Js2Jp8zbX5QXVj686oz7DuI9t5ervMrXjyDDVPOxTnV65H4V8s4.e', '0712344556', 'Avenue Everest', '23', 'Marseille', '13000', 'https://images.freeimages.com/images/small-previews/782/flowers-1363348.jpg', '12345678901234', 'TerraSura', 'Voici mon humble petite boutique de fleurs, je vends principalement des fleurs d''été.' ),
       ('M', 'Albert', 'de Morcerf', 'morcerf@gmail.com', '$2b$10$hkglO21NWeq/LZKRZwMAjupy/xlKrp1PPfInqRed0aQ1kS1xJHZp6', '0761861314', 'Route de Laguet', '11', 'Bordeaux', '33000', 'https://images.freeimages.com/images/small-previews/a53/flowers-1541944.jpg', '12345678901234', 'AgricA', 'Bonjour moi c''est Albert, j''aime les fleurs et les sculptures' ),
       ('F', 'Mercedes', 'Herrera', 'mercedes@gmail.com', '$2b$10$CbL2ZFXLu/4msdC5qEJU4.1U0a8af4QiGKYWBWlBMkwGaeRJSKQm2', '0661673140', 'Avenue Fanny', '2', 'Poitiers', '86000', 'https://images.freeimages.com/images/small-previews/0dd/flowers-1394193.jpg', '12345678901234', 'MercedesFlowers', 'Je m''appelle Mercedes et je fais de l''horticulture' );
